...
# =========== LEXIQUE ===========
LEXICON = {'lithology': ['mort-terrain(?:s)?', 'remblai(?:s)?', 'Quartzite(?:s)?', 'Tourbe(?:s)?', 'Alios', 'Trachyte(?:s)?', 'Granite(?:s)?', 'Ponce(?:s)?', 'Houille(?:s)?', 'Ardoise(?:s)?', 'Anthracite(?:s)?', 'Poudingue(?:s)?', 'Cendres', 'Dolérite(?:s)?', 'Lapillis', 'Tuf volcanique(?:s)?', 'Silex(?:s)?', 'Aplite(?:s)?', 'éclogite(?:s)?', 'Glauconite(?:s)?', 'Bentonite(?:s)?', 'Andésite(?:s)?', 'Cendre(?:s)?', 'Grès', 'Amphibolite(?:s)?', 'Calcaire(?:s)?', 'Molasse(?:s)?', 'brèche(?:s)?', 'Marbre(?:s)?', 'Rhyolite(?:s)?', 'Radiolarite(?:s)?', 'Gabbro(?:s)?', 'Glauconie(?:s)?', 'Kersantite(?:s)?', 'Phonolite(?:s)?', 'tillite(?:s)?', 'Schiste(?:s)?', 'Syénite(?:s)?', 'Ignimbrite(?:s)?', 'Molasse (?:s)?', 'Combarbalite(?:s)?', 'Gravier(?:s)?', 'Gypse(?:s)?', 'Conglomérat(?:s)?', 'Cinérites', 'Craie(?:s)?', 'Cargneule(?:s)?', 'Marne(?:s)?', 'Pierre coquillière(?:s)?', 'Dolomie(?:s)?', 'anhydrite(?:s)?', 'poudingue(?:s)?', 'Cinérite(?:s)?', 'Ophite(?:s)?', 'Pierre coquillère(?:s)?', 'Tuffeau(?:s)?', 'Argile(?:s)?', 'Halite(?:s)?', 'Bauxite(?:s)?', 'Micaschiste(?:s)?', 'Phtanite(?:s)?', 'Péridotite(?:s)?', 'Pyroxénite(?:s)?', 'Carbonatite(?:s)?', 'Kimberlite(?:s)?', 'Monzonite(?:s)?', 'Diatomite(?:s)?', 'Obsidienne(?:s)?', 'Jaspe(?:s)?', 'Arkose(?:s)?', 'Diorite(?:s)?', 'Dacite(?:s)?', 'Cipolin(?:s)?', 'Basalte(?:s)?', 'Anatectite(?:s)?', 'Sable(?:s)?', 'Pegmatite(?:s)?', 'Gneiss', 'Lignite(?:s)?', "Granite d'anatexie(?:s)?", 'Tuf(?:s)?', 'Silcrète(?:s)?', 'Porphyre(?:s)?', 'Brèche(?:s)?', 'Leptynite(?:s)?',],
           'state':['altéré(?:e|es)?', 'sain(?:s)?', 'hétérogène(?:s)?', 'homogène(?:s)?'],
